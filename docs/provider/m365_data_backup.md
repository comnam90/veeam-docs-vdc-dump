...
You can set the retention period (1 year by default) while [adding the Microsoft 365 tenant to Veeam Data Cloud](sp_m365_tenant_add.md). To increase the retention period, contact [Veeam Customer Support](https://www.veeam.com/support.html#Data_Cloud_Support).
