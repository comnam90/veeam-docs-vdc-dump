...
You can set the retention period (1 year by default) while [adding the Microsoft 365 tenant to Veeam Data Cloud](sp_m365_tenant_add.md). For information on how to increase the retention period, see [Editing Backup Repositories](m365_settings_backup_repos.md#editrepo). Once set, you cannot decrease the retention period.
