...
Select the Fast restore check box if you want to select from the fastest available restore points created by OneDrive and SharePoint Express backup policies. The fast restore feature does not apply to Exchange restores. For more information, see [this Microsoft article](https://learn.microsoft.com/en-us/microsoft-365/backup/backup-overview?view=o365-worldwide#restoration-performance).
