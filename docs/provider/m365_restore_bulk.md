...
| --- |
| NOTE |
| The Bulk Restore tab is only visible to users under the Express, Premium and Premium Plus plans and with the M365:Express.BulkRestore permission assigned to their role. |
