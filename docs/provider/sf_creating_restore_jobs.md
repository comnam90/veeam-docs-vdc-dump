...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/sf_creating_restore_jobs.html"
...
| --- |
| Note |
| Restore job drafts older than 7 days are automatically removed from Veeam Data Cloud. |

Veeam Data Cloud offers the following restore options:

* [Restore records](sf_restore_records.md)
* [Restore field values](sf_restore_field_values.md)
