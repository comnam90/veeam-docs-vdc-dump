...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_restore_user_properties.html"
...
To restore Entra ID user properties, use the Compare and Restore Fields wizard.

1. [Launch the Compare and Restore Fields wizard](entra_id_restore_prop_launch.md).
