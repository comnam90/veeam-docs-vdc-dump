...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_restore_app.html"
...
1. [Launch the Restore Applications wizard](entra_id_restore_app_launch.md).
2. [Select restore points](entra_id_restore_app_point.md).
