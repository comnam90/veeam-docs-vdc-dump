...
On the Microsoft 365 page, you can view all added Microsoft 365 workload tenants and information about the Veeam Data Cloud for Microsoft 365 subscription. You can also add a new Microsoft 365 tenant. For details on adding tenants, see [Adding Microsoft 365 Tenants](sp_m365_tenant_add.md).
