...
Before you start using Veeam Data Cloud for Microsoft Azure, review the following limitations and considerations for protecting VMs, Azure SQL Servers and Azure Files.
...
* Veeam Data Cloud for Microsoft Azure does not support using [staging servers](azure_backup_create_sql_process.md) to back up [free offer Azure SQL databases](https://learn.microsoft.com/en-us/azure/azure-sql/database/free-offer?view=azuresql).
