...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/sf_settings_templates.html"
...
When Veeam Data Cloud applies a template while performing a restore operation, the restored data is replaced with randomly generated values so that this information can be shared without compromising confidentiality.

In This Section

* [Adding Data Masking Templates](sf_settings_templates_add.md)
