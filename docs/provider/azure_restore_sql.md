...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/azure_restore_sql.html"
...
You can restore an entire Azure SQL database from an image-level backup. Veeam Data Cloud for Microsoft Azure allows you to restore one or more databases at a time, to the original location or to a new location.
