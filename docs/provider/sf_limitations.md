...
* Backup of custom objects created by 3rd party managed packages, including their metadata, is not supported due to Salesforce limitations. Backup and restore of custom data, such as fields, list views and page layouts, added by a Salesforce Administrator for a custom object that was created by a 3rd party managed package is supported.
