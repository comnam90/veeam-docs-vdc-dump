...
5. [Review default policy settings](azure_backup_create_vm_review.md).
6. [Specify guest processing settings](azure_backup_create_vm_guest.md).
7. [Specify snapshot settings](azure_backup_create_vm_snapshot.md).
