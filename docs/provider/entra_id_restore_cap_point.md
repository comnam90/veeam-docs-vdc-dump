...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_restore_cap_point.html"
...
At the Conditional Access Policies step of the wizard, select restore points to be used for restore.
...
[![Selecting Restore Points](images/entra_id_restore_cap_point.webp)](images/entra_id_restore_cap_point.webp "Selecting Restore Points")
