...
If you have successfully established the Express connection when you [added the Microsoft 365 tenant to Veeam Data Cloud](sp_m365_tenant_add.md), the Express backup service is already active for the tenant.
