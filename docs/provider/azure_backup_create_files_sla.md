...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/azure_backup_create_files_sla.html"
...
| --- |
| Note |
| Veeam Data Cloud for Microsoft Azure takes snapshots automatically according to the schedule of the selected SLA template. You cannot take ad hoc snapshots manually. |
...
[![Specify Policy Protection Settings](images/azure_backup_create_files_sla.webp)](images/azure_backup_create_files_sla.webp "Specify Policy Protection Settings")
