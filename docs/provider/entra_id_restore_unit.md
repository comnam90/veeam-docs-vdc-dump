...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_restore_unit.html"
...
1. [Launch the Restore Administrative Units wizard](entra_id_restore_unit_launch.md).
2. [Select restore points and edit the list of selected units](entra_id_restore_unit_point.md).
