...
On the Entra ID page, you can view all added Entra ID tenants and information on the Veeam Data Cloud for Microsoft Entra ID subscriptions and Veeam Data Cloud maintenance. You can also add a new Entra ID tenant. For details on adding tenants, see [Adding Microsoft Entra ID Tenants](entra_id_tenant_add.md).
...
* The Infrastructure field provides information on the next planned maintenance date. To view all upcoming maintenance that can affect your Entra ID tenants, click See more. For details on Veeam Data Cloud planned maintenance, see [Veeam Data Cloud Maintenance](maintenance.md).
...
| Tenant Name | Name that you specified when adding the tenant and the primary domain name of the Microsoft Entra ID tenant that this Veeam Data Cloud for Microsoft Entra ID tenant is connected to. If the tenant status is Invite Sent, this property shows the email address to which you sent the invitation. |
...
[![Finishing Work with Wizard](images/sp_entra_id_tenant_view.webp)](images/sp_entra_id_tenant_view.webp "Finishing Work with Wizard")
