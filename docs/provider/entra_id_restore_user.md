...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_restore_user.html"
...
1. [Launch the Restore Users wizard](entra_id_restore_user_launch.md).
2. [Select restore points](entra_id_restore_user_point.md).
