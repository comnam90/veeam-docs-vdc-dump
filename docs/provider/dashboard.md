...
The organization dashboard provides a centralized view for monitoring data protection across all workloads in the Veeam Data Cloud organizations of your customers without the need to access the individual tenants management. The Dashboard page contains information about tenant protection status, the number of protected objects and the recent data protection sessions.
...
* To configure the scope by organization, click All Organizations and select one or more organizations.
...
[![Viewing Organization Dashboard](images/sp_dashboard.webp)](images/sp_dashboard.webp "Viewing Organization Dashboard")
