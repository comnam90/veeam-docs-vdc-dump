...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/m365_reports_schedule.html"
...
1. [Launch the Schedule Report wizard](m365_reports_schedule_launch.md).
2. [Specify report details](m365_reports_schedule_details.md).
3. [Select the schedule frequency](m365_reports_schedule_frequency.md).
