...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/vault_storage_vaults_edit.html"
last_updated: "2026"
product_version: ""
---
...
* [For Azure editions] The BYOK (Bring Your Own Key) tag. The tag is visible only if the storage vault uses a customer-managed encryption key. For more information on BYOK encryption, see [Veeam Data Cloud Encryption Keys](https://helpcenter.veeam.com/docs/vdc/userguide/encryption_keys.html). The feature is not available for Partner organizations.
...
[![Viewing Storage Vaults Details](images/vault_storage_vaults.webp)](images/vault_storage_vaults.webp "Viewing Storage Vaults Details")
...
[![Editing Vault Details](images/vault_storage_vault_details.webp)](images/vault_storage_vault_details.webp "Editing Vault Details")
...
[![Assigning Vaults](images/vault_storage_vault_assign.webp)](images/vault_storage_vault_assign.webp "Assigning Vaults")
...
[![Assigning Vaults](images/vault_storage_vault_unassign.webp)](images/vault_storage_vault_unassign.webp "Assigning Vaults")
...
[![Regenerating Secret Key](images/vault_storage_vaults_aws.webp)](images/vault_storage_vaults_aws.webp "Regenerating Secret Key")
...
[![Retrieving Secret Key](images/vault_storage_vault_key_retrieval.webp)](images/vault_storage_vault_key_retrieval.webp "Retrieving Secret Key")
