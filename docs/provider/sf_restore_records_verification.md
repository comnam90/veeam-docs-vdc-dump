...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/sf_restore_records_verification.html"
...
To export the list that contains all records selected at the [Data](sf_restore_records_data.md) step as a CSV file, click Download CSV File. Veeam Data Cloud will save the file with the exported data to the default download folder on the local machine.

[![Checking Permissions](images/sf_restore_records_verification.webp)](images/sf_restore_records_verification.webp "Checking Permissions")
