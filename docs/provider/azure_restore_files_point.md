...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/azure_restore_files_point.html"
...
1. In the Specify restore point section, select the Azure file share and click Change restore point.
2. In the Specify restore point window, select the necessary restore point.

|  |
| --- |
| Tip |
| You can filter the restore points by selecting a backup date or date range. |

1. In the Restore Reason field, by default, Veeam Data Cloud for Microsoft Azure displays the current user and time stamp.

You can edit this field. This information will be saved to the session history, and you will be able to reference it later.

[![Step 2. Select Restore Point](images/azure_restore_files_point.webp)](images/azure_restore_files_point.webp)
