---
title: "Step 1. Launch Restore Conditional Access Policies Wizard"
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_restore_cap_launch.html"
last_updated: "12/12/2025"
product_version: ""
---

# Step 1. Launch Restore Conditional Access Policies Wizard


To launch the Restore Conditional Access Policies wizard, do the following:

1. On the Entra ID page, click the name of the tenant you want to manage.
2. Select Objects.
3. Make sure that the Conditional Access Policies tab is selected.
...
[![Launching Restore Applications Wizard](images/entra_id_restore_cap_launch.webp)](images/entra_id_restore_cap_launch.webp "Launching Restore Applications Wizard")
