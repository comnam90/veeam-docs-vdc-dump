...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_restore_intune.html"
...
1. [Launch the Restore Intune Policies wizard](entra_id_restore_intune_launch.md).
2. [Select restore points](entra_id_restore_intune_point.md).
