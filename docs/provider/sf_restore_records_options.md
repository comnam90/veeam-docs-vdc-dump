...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/sf_restore_records_options.html"
...
In the Data consistency section, you can choose whether you want Veeam Data Cloud to update all existing records and overwrite field values, or to restore only those records that have been deleted from Salesforce without updating the existing records. If you select the Restore deleted records. Overwrite existing records option, you can also decide whether you want to replace non-empty field values of the existing object records in Salesforce with empty (null) values of the backed-up records.
...
[![Configuring Additional Restore Settings](images/sf_restore_records_options.webp)](images/sf_restore_records_options.webp "Configuring Additional Restore Settings")
