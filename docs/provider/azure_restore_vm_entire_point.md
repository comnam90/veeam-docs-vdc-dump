...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/azure_restore_vm_entire_point.html"
...
At the Virtual Machines step of the wizard, select a restore point that will be used to restore the selected Azure VM and specify a reason for restore.
...
1. In the list of the VMs to be restored, select a VM and click Change Restore Point.
...
[![Step 2. Select Restore Point](images/azure_restore_vm_entire_point.webp)](images/azure_restore_vm_entire_point.webp)
