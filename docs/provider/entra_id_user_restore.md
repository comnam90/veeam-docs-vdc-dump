...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_user_restore.html"
...
* [Restore entire users from a backup or Entra ID recycle bin](entra_id_restore_user.md). You can restore one or multiple users.
