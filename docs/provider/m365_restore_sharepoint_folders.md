...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/m365_restore_sharepoint_folders.html"
...
[![Restoring SharePoint Folders](images/m365_restore_sharepoint_folders.webp)](images/m365_restore_sharepoint_folders.webp "Restoring SharePoint Folders")
...
* Download in background. Select this option if you want to download the SharePoint folder to your computer. Veeam Data Cloud for Microsoft 365 will save the SharePoint folder to a .ZIP file. For more information on how to get the downloaded data, see [Obtaining Downloaded Items](m365_obtain_downloaded_items.md).

[![Restoring SharePoint Folders](images/m365_restore_sharepoint_folders_original.webp)](images/m365_restore_sharepoint_folders_original.webp "Restoring SharePoint Folders")
...
[![Restoring SharePoint Folders](images/m365_restore_sharepoint_folders_options.webp)](images/m365_restore_sharepoint_folders_options.webp "Restoring SharePoint Folders")
