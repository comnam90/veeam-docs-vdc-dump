...
product: "vdc"
doc_type: "provider"
source_url: "https://helpcenter.veeam.com/docs/vdc/provider/entra_id_object_export.html"
...
You can export only one object type at a time. If you want to export more object types, run a separate export session for each object type.

To export objects, do the following:

1. [Launch the Export Objects wizard](entra_id_object_export_launch.md).
2. [Select the restore points](entra_id_object_export_point.md).
