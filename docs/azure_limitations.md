...
* Due to Azure resources Azure SQL Managed Instance size limits, it is recommended that you back up Azure SQL databases up to 16 TB in size for optimal reliability. Backup of larger databases has not been tested and may not be supported.
