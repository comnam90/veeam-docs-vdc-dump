...
* [Restore entire Intune policies from a backup](entra_id_restore_intune.md). You can restore one or multiple objects.
* [Restore specific Intune policy properties](entra_id_restore_intune_prop.md). You can restore one or multiple properties.
