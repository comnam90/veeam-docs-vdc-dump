...
Users of the Variable License Model can add and remove users and objects to and from Flex backup policies created in Veeam Data Cloud for Microsoft 365.

If you want to edit Flex backup policies under the Fixed License Model, see [Fixed License Model](#FixedLicense).
...
1. In the Exclude more items section, click Select next to Users, Groups, SharePoint Sites or Teams and select specific objects to exclude.
...
Users of the Fixed License Model can add and remove users and objects to and from Flex backup policies created in Veeam Data Cloud for Microsoft 365.

To edit Flex backup policies under the Variable License Model, see [Variable License Model](#VarLicense).
