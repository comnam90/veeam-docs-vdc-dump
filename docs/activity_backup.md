...
For each data protection operation, Veeam Data Cloud starts a new backup session according to created backup policies. On the Activity page, you can review all running and completed backup sessions across all workloads within your Veeam Data Cloud organization. This helps you quickly identify failed or warning sessions and take corrective action.
