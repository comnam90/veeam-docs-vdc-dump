...
To create new backup policies, use the New Backup Policy wizard:

1. [Launch the New Backup Policy wizard](m365_backup_create_flex_launch.md).
2. [Configure policy information](m365_backup_create_flex_config_policy.md).
3. [Configure backup data](m365_backup_create_flex_config_data.md).
4. [Finish working with the wizard](m365_backup_create_flex_finish.md).
