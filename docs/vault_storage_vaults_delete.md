...
source_url: "https://helpcenter.veeam.com/docs/vdc/userguide/vault_storage_vaults_delete.html"
...
3. Veeam Data Cloud Vault switches the storage vault status from Active to IsDeleting and the 10 day grace period begins.
4. After the 10 day grace period, Veeam Data Cloud Vault switches the storage vault status from IsDeleting to Delete.
