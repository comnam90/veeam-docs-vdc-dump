---
title: "Deleting Non-Empty Storage Vaults"
product: "vdc"
doc_type: "userguide"
source_url: "https://helpcenter.veeam.com/docs/vdc/userguide/vault_storage_vaults_delete_nonempty.html"
last_updated: "4/1/2026"
product_version: ""
---

# Deleting Non-Empty Storage Vaults


You can permanently delete a storage vault that contains data from the backup infrastructure. To do that, you must contact [Veeam Customer Support](https://www.veeam.com/support.html#Data_Cloud_Support).
...
The procedure to delete a non-empty storage vault works in the following way:
...
| --- |
| Tip |
| You can permanently delete an empty storage vault directly in the Veeam Data Cloud customer portal. For details, see [Deleting Empty Storage Vaults](vault_storage_vaults_delete_empty.md). |
