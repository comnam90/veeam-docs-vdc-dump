...
5. If you want to view all the available restore points for a OneDrive, in the Actions column of the OneDrive, click View all restore points of this object. In the Restore Points window, you can view all the restore points for the drive, from newest to oldest.
6. Select the check box next to the user whose OneDrive you want to restore.
