...
In Backup Policies, select one of the following options:
...
[![Configuring Backup Data](images/m365_tenant_add_backup.png)](images/m365_tenant_add_backup.png "Configuring Backup Data")
